...
namespace Camel.Core.Migrations
{
    ...
    [Migration("20240728133820_AddCommentsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Camel.Core.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("BeatmapId")
                        .HasDatabaseName("ix_comments_beatmap_id");

                    b.HasIndex("ScoreId")
                        .HasDatabaseName("ix_comments_score_id");
            ...
            modelBuilder.Entity("Camel.Core.Entities.Comment", b =>
                {
                    b.HasOne("Camel.Core.Entities.User", "Author")
                    ...
                    b.HasOne("Camel.Core.Entities.Beatmap", "Beatmap")
                        ...
                        .HasConstraintName("fk_comments_beatmaps_beatmap_id");

                    b.HasOne("Camel.Core.Entities.Score", "Score")
                        .WithMany("Comments")
                        .HasForeignKey("ScoreId")
                        .HasConstraintName("fk_comments_scores_score_id");
