...
public readonly struct UserStats : IPacketPayload
{
    public int Id { get; }
    ...
    public UserStats(int id, ClientAction action, string infoText, string mapMd5, int mods, GameMode mode, int mapId,
